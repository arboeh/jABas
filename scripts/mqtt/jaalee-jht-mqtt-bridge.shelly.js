 ...
 * @status production
 * @link https://github.com/arboeh/jABas/blob/main/scripts/mqtt/jaalee-jht-mqtt-bridge.shelly.js
 */
...
function init() {
    ...
    if (typeof CONFIG === 'undefined') {
        console.log('[ERROR] jABas-jaalee-jht v' + VERSION + ': Undefined config');
        return;
    }
